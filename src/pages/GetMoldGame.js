...
const getMoldImg = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-274-get_mold.png";
const mortarImg = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-4848-fill_solution.png";
const microwave = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-4916-microwave_img.png";
const sampleBeakerImg = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-505-sample.png";
const sampleTiledBeakerImg = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-5043-sample_tiled.png";
const mortarActiveImg2 = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-5120-solution.png";
const mortarActiveImg = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-520-solution_fill.png";
const solventBeakerImg = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-5233-solvent.png";
const solventTiledBeakerImg = "https://jadavpuruniversity.s3-ap-south-1.amazonaws.com/9-2024-26-5313-solventTiled.png";
          ...
          <Box>
            ...
            >
              ...
              <ol style={{ marginLeft: "20px" }}>
                ...
                <li>
                  Click on the Agarose Beaker to transfer small amount (around
                  1mg) of Aragose into the empty Solution Beaker
                </li>
                <li>
                  Click on the Buffer Beaker to transfer 5 ml of the Buffer
                  Solvent to the Solution Beaker.
                </li>
                <li>
                ...
                <li>
                  ...
                  solution needs to be heated on high temperature for some time.
                </li>
                <li>
                ...
                <li>
                  ...
                  you have succesfully prepared your Gel.
                </li>
                <li>
                  Click on Restart option in the Control Menu to restart the
